...
# Use simple split and replace
start_idx = content.find('  // ── One-time seed: handwritten log entries (Sept 2026)')
end_idx = content.find('  renderTable();', start_idx)

if start_idx != -1 and end_idx != -1:
    content_new = content[:start_idx] + new_block + '\n\n' + content[end_idx:]
